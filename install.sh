...
if [ "$EXISTING_PROJECT" = true ]; then
    ...
    echo ""
    echo "Available skills (27 total — see CLAUDE.md for full list):"
    echo "  /lint           - Run linters and formatters"
    echo "  /test           - Run tests with coverage"
    echo "  /review         - Project review lens (resiliency + venv hygiene)"
    echo "  /capture        - Save plans/decisions to .claude/plans/"
